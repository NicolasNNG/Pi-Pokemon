  ...
  switch (action.type) {
    ...
    case FILTER_API_DB:
      ...
      if (action.payload === "api") {
        pokemonsFiltrados = state.newPokemons.filter(
          (poke) => poke.id.toString().length < 6
        );
    ...
    case ORDER_NAME_A_TO_Z:
      ...
      if (action.payload === "A") {
        ...
        const result = allPokesCopy.sort((a, b) =>
      ...
      if (action.payload === "Z") {
        const result = [...state.pokemons].sort((a, b) =>
